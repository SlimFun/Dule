  ...
  <body>
  	<dir class="warp">
  		<div class="row">
  			...
  			<form class="col s12" action="<%=basePath%>user/admin/doLogin" method="post">
  				<div class="row">
  					...
  					<div class="input-field col s8 offset-s2">
			          	<input id="loginName" type="text" class="validate" name="loginName" value="<s:property value="loginName"/>" required>
			          	<label for="loginName">ID/UserName/Email：</label>
			        </div>
			        <div class="input-field col s8 offset-s2">
