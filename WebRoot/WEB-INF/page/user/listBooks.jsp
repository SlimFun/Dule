...
<html>
  ...
  <body>
  	...
  	<div class="row">
  		...
  		<s:iterator value="books.datas" var="data">
  			<div class="col s3" style="margin: 0px;margin-top: 30px; height: 190px;width: 335px">
			    <div class="card">
			      <div class="row">
			      		<div class="col s4" style="padding: 0px">
					      	...
					      	<div class="card-image">
					        	<img class="activator" src="upload/<s:property value="#data.bookInfo.img"></s:property>">
				        	</div>
			      		</div>
			      		<div class="col s8">
					        	<p>
					        	Book Name：<s:property value="#data.bookInfo.name"></s:property><br>
				        		Author：<s:property value="#data.bookInfo.author"></s:property><br>
				        		Publisher：<s:property value="#data.bookInfo.publisher"></s:property><br>
				        		DateOfPublish：<s:date name="#data.bookInfo.dateOfPub"   format="yyyy-MM-dd" nice="false"/><br>
				        		Type：<s:property value="#data.bookInfo.type.name"></s:property><br> 
				        		</p>
					    </div>
			      </div>
			      <div class="card-reveal">
				      ...
				      <span class="card-title grey-text text-darken-4">Info<i class="material-icons right">close</i></span>
				     	<p>
				     		Borrowed Date: <s:date name="#data.borrowedDate"   format="yyyy-MM-dd" nice="false"/> <br/>
				     		Left <s:property value="#data.leftDays"/> Days.
				   	    </p>
				   	</div>
			    </div>
	  		</div>
